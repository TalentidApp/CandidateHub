...
const useAuthStore = create(
  persist(
    (set, get) => ({
      ...
      error: null,
      offers: [],
      feedbackData: {}, // { [companyId]: feedbackArray }
      companies: {}, // { [companyName]: { _id, companyName, rating, ... } }
      ...
      setCompanyData: (companyName, company) =>
        set((state) => ({
          companies: { ...state.companies, [companyName]: company },
        })),
    }),
    {
      name: "auth-storage",
